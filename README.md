[![npm](https://img.shields.io/npm/v/@erboladaiorg/quidem-magni-commodi.svg)](https://www.npmjs.com/package/@erboladaiorg/quidem-magni-commodi) ![downloads](https://img.shields.io/npm/dt/@erboladaiorg/quidem-magni-commodi.svg) [![CI](https://github.com/erboladaiorg/quidem-magni-commodi/actions/workflows/ci.yml/badge.svg)](https://github.com/erboladaiorg/quidem-magni-commodi/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@erboladaiorg/quidem-magni-commodi/renderer](https://www.npmjs.com/package/@@erboladaiorg/quidem-magni-commodi/renderer).

## tl;dr

- Install by executing `npm install @erboladaiorg/quidem-magni-commodi` or `yarn add @erboladaiorg/quidem-magni-commodi`.
- Import by adding `import { Document } from '@erboladaiorg/quidem-magni-commodi'`.
...
[Online demo](https://projects.wojtekmaj.pl/@erboladaiorg/quidem-magni-commodi/) is also available!
...
- [v6.x](https://github.com/erboladaiorg/quidem-magni-commodi/blob/v6.x/README.md)
- [v5.x](https://github.com/erboladaiorg/quidem-magni-commodi/blob/v5.x/README.md)
- [v4.x](https://github.com/erboladaiorg/quidem-magni-commodi/blob/v4.x/README.md)
- [v3.x](https://github.com/erboladaiorg/quidem-magni-commodi/blob/v3.x/README.md)
- [v2.x](https://github.com/erboladaiorg/quidem-magni-commodi/blob/v2.x/README.md)
- [v1.x](https://github.com/erboladaiorg/quidem-magni-commodi/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @erboladaiorg/quidem-magni-commodi` or `yarn add @erboladaiorg/quidem-magni-commodi`.
...
```ts
import { pdfjs } from '@erboladaiorg/quidem-magni-commodi';
...
import { Document, Page } from '@erboladaiorg/quidem-magni-commodi';
...
Check the [sample directory](https://github.com/erboladaiorg/quidem-magni-commodi/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/erboladaiorg/quidem-magni-commodi/wiki/Recipes) in [React-PDF Wiki](https://github.com/erboladaiorg/quidem-magni-commodi/wiki/).
...
```ts
import '@erboladaiorg/quidem-magni-commodi/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@erboladaiorg/quidem-magni-commodi/dist/Page/TextLayer.css';
```
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@erboladaiorg/quidem-magni-commodi__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@erboladaiorg/quidem-magni-commodi__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@erboladaiorg/quidem-magni-commodi__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@erboladaiorg/quidem-magni-commodi__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/erboladaiorg/quidem-magni-commodi/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@erboladaiorg/quidem-magni-commodi-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@erboladaiorg/quidem-magni-commodi-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@erboladaiorg/quidem-magni-commodi-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@erboladaiorg/quidem-magni-commodi-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@erboladaiorg/quidem-magni-commodi-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@erboladaiorg/quidem-magni-commodi-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@erboladaiorg/quidem-magni-commodi/contributors.svg?width=890&button=false)
